...
<div class="form-group">
  <label for="name"><span class="label label-default">USERNAME</span></label>
  <input type="text"
    class="form-control" name="name" id="name" aria-describedby="helpNname" placeholder="name">
...
<div class="form-group">
  ...
  <input type="text"
    class="form-control" name="mail" id="mail" aria-describedby="helpMail" placeholder="example@example.fr">
